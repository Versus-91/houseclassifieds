...
{
    public abstract class classifiedsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static classifiedsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(classifiedsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<classifiedsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<classifiedsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<classifiedsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<classifiedsDbContext, Task<T>> func)
        {
            T result;
